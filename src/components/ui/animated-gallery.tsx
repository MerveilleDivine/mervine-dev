...
export const GalleryContainer = ({
  ...
  return (
    <motion.div
      className={cn(
        "relative grid size-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 rounded-2xl px-4",
        className
      )}
      style={{
        rotateX,
...
export const GalleryCol = ({
  ...
  return (
    <motion.div
      className={cn("relative flex w-full flex-col gap-2 sm:gap-3", className)}
      style={{
        y,
        ...style,
      }}
