  ...
  return (
    ...
    >
      ...
      <div className="relative bg-gradient-to-br from-white via-gray-50/50 to-white dark:from-zinc-800 dark:via-zinc-850 dark:to-zinc-900 rounded-xl overflow-hidden h-full flex flex-col border border-gray-200/50 dark:border-zinc-700/50 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500">
        ...
        <div className="relative h-40 sm:h-48 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-zinc-700 dark:to-zinc-800 overflow-hidden flex-shrink-0">
          <motion.img 
          ...
          {category && (
            ...
            >
              <div className={`flex items-center gap-1 sm:gap-2 ${getCategoryGradient()} text-white px-2 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold shadow-2xl backdrop-blur-md border border-white/20`}>
                <motion.div
                  animate={{ rotate: 360 }}
          ...
          >
            <motion.button
              ...
              className="bg-white/95 dark:bg-zinc-800/95 backdrop-blur-md text-gray-800 dark:text-white p-2 sm:p-3 rounded-full shadow-2xl border border-white/20 dark:border-zinc-600/20"
        ...
        {/* Enhanced Content - Better mobile layout */}
        <div className="p-4 sm:p-6 flex flex-col flex-1 min-h-0">
          {/* Title with premium animation */}
          <motion.div 
            className="flex items-center justify-between mb-2 sm:mb-3 flex-shrink-0"
          ...
          <motion.p 
            className="text-gray-600 dark:text-gray-300 mb-3 sm:mb-4 text-xs sm:text-sm leading-relaxed flex-shrink-0 h-8 sm:h-10 overflow-hidden"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.div 
            className="mb-3 sm:mb-4 flex-shrink-0 h-14 sm:h-16"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.6 + index * 0.1 }}
          >
            <h4 className="text-xs font-bold text-transparent bg-gradient-to-r from-primary to-secondary bg-clip-text mb-1 sm:mb-2 tracking-wider uppercase">
              Key Features
            </h4>
              ...
              {features.slice(0, 2).map((feature, idx) => (
                ...
                >
                  ...
                  <div className="relative text-xs bg-gradient-to-r from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10 text-gray-700 dark:text-gray-300 px-2 py-1 rounded-lg flex items-center border border-primary/20 hover:border-primary/40 transition-all duration-300">
                    <motion.div 
                      className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gradient-to-r from-primary to-secondary rounded-full mr-1 sm:mr-2 flex-shrink-0"
          ...
          {/* Premium Tech Stack - Mobile optimized */}
          <motion.div 
            className="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4 flex-shrink-0 min-h-[24px] sm:min-h-[32px]"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {techStack.slice(0, 4).map((tech, techIndex) => (
              ...
              >
                <span className="relative z-10 text-xs">{tech}</span>
          ...
          <motion.div 
            className="flex gap-2 sm:gap-3 mt-auto pt-3 sm:pt-4 border-t border-gray-100 dark:border-zinc-700"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.button 
              ...
              className="flex-1 flex items-center justify-center gap-1 sm:gap-2 text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-all duration-300 py-2 sm:py-2.5 px-3 sm:px-4 rounded-xl border border-gray-200 dark:border-zinc-600 hover:border-primary/40 hover:bg-gradient-to-r hover:from-primary/5 hover:to-secondary/5 font-semibold text-xs sm:text-sm backdrop-blur-sm group/btn"
            ...
            <motion.button 
              onClick={handleLiveDemo}
              className="flex-1 flex items-center justify-center gap-1 sm:gap-2 bg-gradient-to-r from-primary via-primary/90 to-secondary text-white py-2 sm:py-2.5 px-3 sm:px-4 rounded-xl hover:from-primary/90 hover:via-secondary/90 hover:to-primary font-bold text-xs sm:text-sm shadow-xl hover:shadow-2xl transition-all duration-500 relative overflow-hidden group/btn"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
