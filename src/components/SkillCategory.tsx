    ...
    <div className="relative h-full rounded-xl overflow-hidden">
      <div className="relative h-full rounded-xl border-[0.75px] border-border p-2">
        <GlowingEffect
          ...
          borderWidth={2}
        />
        <div className="relative flex flex-col rounded-lg border-[0.75px] border-border bg-white dark:bg-zinc-800 p-4 sm:p-5 lg:p-6 shadow-md transition-transform hover:-translate-y-1 h-full">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-2.5 mt-2 sm:mt-3 overflow-hidden">
