    ...
    <div className="relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <Calendar size={18} className="transition-transform duration-300 flex-shrink-0" />
          </motion.div>
          <span className="text-sm sm:text-base lg:text-lg truncate">{t('graphics.book_consultation')}</span>
        </motion.button>
      </motion.div>
    </div>
  );
